...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_lanelet_map = wx.ToggleButton(self.tab_map, wx.ID_ANY, _("Lanelet Map"))
		self.panel_lanelet_map = wx.Panel(self.tab_map, wx.ID_ANY)
		self.static_line_6 = wx.StaticLine(self.tab_map, wx.ID_ANY)
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_lanelet_map)
	...
	def __set_properties(self):
		...
		self.button_lanelet_map.SetMinSize((125, 29))
	...
	def __do_layout(self):
		...
		sizer_53_copy_41 = wx.BoxSizer(wx.HORIZONTAL)
		...
		sizer_53_copy_41.Add(self.button_lanelet_map, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
		sizer_53_copy_41.Add(self.panel_lanelet_map, 1, wx.ALIGN_CENTER_VERTICAL, 0)
		sizer_61.Add(sizer_53_copy_41, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 4)
		sizer_61.Add(self.static_line_6, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 4)
