...
void RegionTLRSSDROSNode::RunRecognition()
{
  ...
  recognizer.Init(network_definition_file_name_, pretrained_model_file_name_, use_gpu_, gpu_id_);
...
void RegionTLRSSDROSNode::StartSubscribersAndPublishers()
{
  ...
  image_subscriber = node_handle.subscribe(image_topic_name_, 1, &RegionTLRSSDROSNode::ImageRawCallback, this);
...
// ===============================================================================
LightState RegionTLRSSDROSNode::DetermineState(LightState previous_state, LightState current_state,
